...
## Environments
- Preview: https://main--cpilsworth-dnata--aemysites.aem.page/
- Live: https://main--cpilsworth-dnata--aemysites.aem.live/
- Block Library: https://main--cpilsworth-dnata--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `cpilsworth-dnata` directory in your favorite IDE and start coding :)
